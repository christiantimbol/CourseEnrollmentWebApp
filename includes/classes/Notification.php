...
class Notification {
	...
	public function insertNotification($post_id, $user_to, $type) {
		...
		switch($type) {
			case 'comment':
				$message = $userLoggedInName . " commented on your course";
				break;
			case 'like':
				$message = $userLoggedInName . " matched your course";
				break;
			case 'profile_post':
				$message = $userLoggedInName . " posted on your profile";
				break;
			case 'comment_non_owner':
				$message = $userLoggedInName . " commented on a course you commented on";
				break;
